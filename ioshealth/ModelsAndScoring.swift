...
struct AnomalyReport: Codable, Sendable, Identifiable, Hashable { var id = UUID(); let startedAt: Date; let reconstructionPercentile: Double; let personalPredictionPercentile: Double; let populationPredictionPercentile: Double; let finalPercentile: Double; let level: RiskLevel; let reason: String }
